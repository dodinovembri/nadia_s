        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <center><h3 class="box-title"><strong>Update Merk</strong></h3></center>
            </div>
           <!-- /.box-header -->
           <?php 
           ...
           ?>
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="?module=simpan_update_merk">      
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Nama Merk</label>
                          	<div class="col-sm-10"><input type="text" name="merk" class="form-control" placeholder="Jumlah Daya" value="<?php echo $merk_db; ?>" required><br><br>
                        	</div>
                        </div>
                        <br><br>                                            
