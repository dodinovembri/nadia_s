                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-lg-3 col-xs-6">
                      <!-- small box -->
                      <a href="?module=hal_input"><div class="small-box bg-aqua">
                        <div class="inner">
                          <h3>Form</h3>
                          <p>Form Input Data</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                      <!-- small box -->
                      <a href="?module=hal_data"><div class="small-box bg-green">
                        <div class="inner">
                          <h3>Data</h3>

                          <p>Data Asli Dan Training</p>
                        </div>
                        <div class="icon">
                          <i class="ion fa-unlink"></i>
                        </div>
                        <div class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></div>
                      </div>
                      </a>
                    ...
                    <div class="col-lg-3 col-xs-6">
                      <!-- small box -->
                      <a href="?module=backpro"><div class="small-box bg-yellow">
                        <div class="inner">
                          <h3>Prediksi</h3>

                          <p>Prediksi Masa Pakai Kwh</p>
                        </div>
                        <div class="icon">
                          <i class="ion fa-gg"></i>
                        </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                      <!-- small box -->
                      <a href="?module=user"><div class="small-box bg-red">
                        <div class="inner">
