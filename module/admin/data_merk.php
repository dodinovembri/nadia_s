                 ...
                 <?php
                    ...
                    ?>                                              
                            <tr>
                                ...
                                <td>                                	
                                	<a href="?module=update_data_merk&id_merk=<?php echo $row['id_merk']; ?>"><button type="button" class="btn btn-warning">Update</button></a>
                                	<a href="?module=hapus_data_merk&id_merk=<?php echo $row['id_merk']; ?>"><button class="btn btn-danger" onclick="return konfirmasi()">Delete</button></a>                        			   
                                </td>
                            </tr>
                    <?php
                        }
