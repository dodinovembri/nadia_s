        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <center><h3 class="box-title"><strong>Input Daya</strong></h3></center>
            </div>
           <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="?module=simpan_daya">                      
                        <div class="form-group"><label class="col-sm-2 control-label">Jumlah Daya</label>
                          	<div class="col-sm-10"><input type="text" name="daya" class="form-control" placeholder="Jumlah Daya" required><br><br>
                        	</div>
                        </div>
                        <br><br>                                            
