                 ...
                 <?php
                    ...
                    ?>                                              
                            <tr>
                                ...
                                <td>                                	
                                	<a href="?module=update_data_stand&id_stand=<?php echo $row['id_stand']; ?>"><button type="button" class="btn btn-warning">Update</button></a>
                                	<a href="?module=hapus_data_stand&id_stand=<?php echo $row['id_stand']; ?>"><button class="btn btn-danger" onclick="return konfirmasi()">Delete</button></a>                        			   
                                </td>
                            </tr>
                    <?php
                        }
