                            ...
                            {                                
                                ...
                                {                              
                                    ...
                                    if (!empty($id_pelanggan) || !empty($nama) || !empty($alamat) || !empty($tarip) || !empty($daya) || !empty($stand_lama) || !empty($merk_lama) || !empty($tipe_lama) || !empty($no_seri_lama) || !empty($tahun_lama) || !empty($jenis) || !empty($masa_pakai)) {
                                        $query = "insert into tbl_data (id_pelanggan, nama, alamat, tarip, daya, stand_lama, merk_lama, tipe_lama, no_seri_lama, tahun_lama, jenis, masa_pakai) values('".$id_pelanggan."','".$nama."', '".$alamat."', '".$tarip."', '".$daya."', '".$stand_lama."', '".$merk_lama."', '".$tipe_lama."', '".$no_seri_lama."', '".$tahun_lama."', '".$jenis."', '".$masa_pakai."')";
