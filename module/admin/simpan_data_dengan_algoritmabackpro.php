                  ...
                  <?php
                      ...
                      if ($_POST['status'] == "cal") {
                        ...
                        if ($id_pelanggan_db == $id_pelanggan) {
                          ...
                          $query = "INSERT INTO data_set (`id_pelanggan`, `nama`, `alamat`, `tarip`, `daya`, `stand`, `merk`, `tipe`, `no_seri`, `jenis`, `tahun`, `prediksi`, `masa_prediksi`) VALUES ('$id_pelanggan', '$nama', '$alamat', '$tarip', '$daya', '$stand', '$merk', '$tipe', '$no_seri', '$jenis', '$tahun', '$outPred', '$total')";
